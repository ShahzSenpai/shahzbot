...
/////////////////
const BotName = 'SHAHZ BOT'; 
const instagram = 'https://instagram.com/shahril_rizall?igshid=2cr7jbokyb5r'; 
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@shahril_rizall`)
})
